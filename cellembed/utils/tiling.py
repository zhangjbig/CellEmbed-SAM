...
def _stitch(tiles: list, shape: tuple, chop_list: list, final_shape: tuple, offset : int):
    ...
    from cellembed.utils.pytorch_utils import torch_fastremap, match_labels, _to_ndim

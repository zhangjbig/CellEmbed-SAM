...
import zarr
import os
from cellembed.utils.pytorch_utils import _to_tensor_float32
pixel_size_precision = 0.01
def _to_ndim(x, *args, **kwargs):
    from cellembed.utils.pytorch_utils import _to_ndim as _to_ndim_pytorch
    from cellembed.utils.pytorch_utils import _to_ndim_numpy
...
class InstanSeg():
    ...
    def __init__(self, 
        ...
        """
        from cellembed.utils.utils import download_model, _choose_device
    ...
    def _normalise(self, image: torch.Tensor) -> torch.Tensor:
        from cellembed.utils.utils import percentile_normalize, _move_channel_axis
    ...
    def save_output(self,
        ...
        if save_geojson:
            ...
            from cellembed.utils.utils import labels_to_features
            import json
    ...
    def eval_small_image(self,
        ...
        """
        from cellembed.utils.utils import percentile_normalize, _filter_kwargs
    ...
    def eval_medium_image(self,
        ...
        from cellembed.utils.tiling import _sliding_window_inference
        original_shape = image.shape
    ...
    def eval_whole_slide_image(self,
            ...
            from cellembed.utils.pytorch_utils import torch_fastremap, match_labels
            from pathlib import Path
            from tqdm import tqdm
            from cellembed.utils.tiling import _chops, _remove_edge_labels, _zarr_to_json_export
    ...
    def display(self,
        ...
        """
        from cellembed.utils.utils import save_image_with_label_overlay
    ...
    def _cluster_instances_by_mean_channel_intensity(self, image_tensor: torch.Tensor, 
        ...
        from cellembed.utils.biological_utils import get_mean_object_features
        import fastremap
        import numpy as np
        from cellembed.utils.utils import apply_cmap, _choose_device
...
def _display_colourized(mIF, normalise = True):
    from cellembed.utils.utils import _move_channel_axis, generate_colors, percentile_normalize
